...
//                 VALUES (?, ?, ?, ?, ?)`,
// 			profile.Artist, profile.Title, yearInt, imageData, imageSize, false)
...
// 	// Post /album/:likeOrNot/:albumId -> insert like or dislike
// 	r.PUT("/album/:likeOrNot/:albumId", func(c *gin.Context) {
...
// 		_, err = db.Exec("UPDATE album SET like_or_not = ? WHERE id = ?", like, id)
// 		if err != nil {
// 			c.JSON(500, gin.H{"error": err.Error()})
// 			return
// 		}
